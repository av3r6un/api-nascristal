...
from src.core.change_logging import DEFAULT_CHANGE_LIMIT, fetch_recent_changes, render_change
...
async def get_recent_changes(
  ...
  return {"items": [render_change(event, locale) for event in events]}
